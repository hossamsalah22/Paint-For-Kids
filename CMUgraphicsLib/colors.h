...
const color CUSTOMCOLOR1 = color(255, 255, 255);
const color CUSTOMCOLOR2 = color(0, 0, 0);
const color CUSTOMCOLOR3 = color(110, 50, 13);
const color CUSTOMCOLOR4 = color(106, 54, 154);
const color CUSTOMCOLOR5 = color(218, 10, 146);
const color CUSTOMCOLOR6 = color(233, 28, 43);
const color CUSTOMCOLOR7 = color(245, 137, 29);
const color CUSTOMCOLOR8 = color(235, 206, 42);
const color CUSTOMCOLOR9 = color(10, 164, 80);
const color CUSTOMCOLOR10 = color(69, 161, 228);
