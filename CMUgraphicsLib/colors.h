...
const color BLUE = color(69, 161, 228);
...
const color GREEN = color(10, 164, 80);
...
const color YELLOW = color(235, 206, 42);
...
const color PURPLE = color(106, 54, 154);
